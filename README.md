...
<head>
    ...
    <style>
        ...
        #socials, #languages, #stats {
            margin: 20px;
        }
        #socials h3, #languages h3 {
            font-size: 24px;
            color: #f00;
            margin: 10px 0;
        }
        #socials a, #languages a {
            margin: 5px;
            display: inline-block;
        }
        #socials img, #languages img {
            transition: transform 0.3s, box-shadow 0.3s;
        }
        #socials img:hover, #languages img:hover {
            transform: scale(1.1);
...
<div align="center" id="discord-id">
    <p>Discord ID: fiestyvortax2</p>
</div>
